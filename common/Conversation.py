...
class ConversationManager:
    ...
    def shutdown(self):
        debug.mojolog.write("self._map_inmsgid_to_info: %s\n", args=(self._map_inmsgid_to_info,), v=6, vs="debug")
        self.__callback_functions = {}
        ...
        if nonce is not None :
            ...
            if initial is not None:
                ...
                if post_timeout_callback_function:
                    ...
                    debug.mojolog.write("post timeout callback for response of type %s to msgId %s\n", args=(responsetype, reference,), v=5, vs='Conversation')
                else:
    ...
    def handle_raw_message(self, counterparty_id, inmsg, commstrat=None):
        ...
        if commstrat:
            ...
            debug.mojolog.write("complaint: I wish that I had a reference to a persistent CommStrat object that represents this particular way of talking to this counterparty, so that I could use it to store hints to optimize behaviour.  Oh well.  counterparty_id: %s\n", args=(counterparty_id,), v=5, vs="debug")
        ...
        try: # for BadFormatErrors
            ...
            debug.stderr.write("_process(): BadFormatError in message from %s, msg: %s, error: %s\n", args=(counterparty_id, inmsg, le,), v=2, vs="conversation")
